...
function Actor(ctx, startPosition, canvas, camera, collisionHandler, resources) {
    ...
    this._drawNoOfLifesRemaining = function () {
        ...
        _this.ctx.drawImage(_this.resources.getImage('characterHead'), 0, 0, 62, 62, marginLeft + 1050, 40, 62, 62);
        _this.ctx.drawImage(_this.resources.getImage('noOfLifesImage'), 0, this.noOfLifes * 35 - 35, 80, 35, marginLeft + 1120, 50, 80, 35);
    };
    ...
    this._statusBox = function () {
        ...
        _this.ctx.drawImage(_this.resources.getImage('statusIconsImage'), 0, 0, 35, 90, marginLeft + 70, 50, 25, 68);
    ...
    this.drawWeapon = function () {
        ...
        var weaponBackPositionX, weaponBackPositionY;
        var pat;
        ...
        _this.weaponTipPositionX = weaponBackPositionX + vectorX * length;
        _this.weaponTipPositionY = weaponBackPositionY + vectorY * length;

        var slope = (weaponBackPositionY - _this.weaponTipPositionY) / (weaponBackPositionX - _this.weaponTipPositionX);
        ...
        if(_this.faceSide == 'left') {
            _this.ctx.translate( _this.weaponTipPositionX, _this.weaponTipPositionY);
        }else {
