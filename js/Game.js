...
function Game(canvas, resources) {
    ...
    this.respawn = function () {
        ...
        if(_this.shyame.actor.score > _this.bestScore) {
            _this.bestScore = _this.shyame.actor.score;
            Util.setCookie('bestScore', 0, 1000);
            Util.setCookie('bestScore', _this.bestScore, 1000);
        }
        ...
        document.getElementById('best').innerHTML = _this.bestScore;
    ...
    this.fireBulletEvent = function(e){
        ...
        _this.gameBullets[Object.size(_this.gameBullets)] = _this.shyame.actor.weapon.fireBullet({x: _this.shyame.actor.weaponTipPositionX, y: _this.shyame.actor.weaponTipPositionY - 50}, _this.getMousePos(_this.canvas, e));
