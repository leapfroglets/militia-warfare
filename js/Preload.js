...
function Preload(){
    ...
    this._init = function () {
        ...
        this.resources.addImage('characterHead', 'images/character/head.png');
        this.resources.addImage('noOfLifesImage', 'images/no_of_lifes.PNG');
        this.resources.addImage('statusIconsImage', 'images/status_icons.png');
