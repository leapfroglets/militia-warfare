    ...
    this._init = function() {
        ...
        this.aiInterval = setInterval(function () {
            ...
            if(distanceToShyame < _this.maxSafeDistance)
                _this.game.gameBullets[Object.size(_this.gameBullets)] = _this.weapon.fireBullet({x: _this.weaponTipPositionX, y: _this.weaponTipPositionY - 50}, {x: positionToFireX, y: positionToFireY});
